 ...
 */
export function create(name, value, options = {}) {
	const { maxAge, expires, path, domain, sameSite, secure, httpOnly } = Object.assign(
 ...
 */
export function bulk(values, options = {}) {
